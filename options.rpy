...
init -1 python hide:
    ...
    config.window_title = u"More Than Enough"
    ...
    theme.diamond(
        ...
        mm_root = "assets/bokeh_clock.jpg",

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "assets/bokeh_clock.jpg",
    ...
    style.default.font = "assets/font/LibreBaskerville-Regular.ttf"
    ...
    config.main_menu_music = "assets/jared_c_balogh_watching.mp3"
...
python early:
    config.save_directory = "More Than Enough-1424891882"
...
init python:
    ...
    build.directory_name = "more-than-enough-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "More Than Enough"
